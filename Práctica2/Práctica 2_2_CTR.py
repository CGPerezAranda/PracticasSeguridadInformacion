...
class AES_CIPHER:
    ...
    def cifrar(self, cadena, IV):
        ...
        # Crea un mecanismo de cifrado AES en modo CTR 
        cadena = cadena.encode("utf-8")
        cypher = AES.new(self.key, AES.MODE_CTR, nonce=IV)
    ...
    def descifrar(self, cifrado, IV):
        ...
        # Creo un mecanismo de descifrado AES en modo CTR
        decipher_aes = AES.new(self.key, AES.MODE_CTR, nonce=IV)
...
IV = get_random_bytes(8)  # IV aleatorio de 64 bits (tamaño del bloque / 2)
datos = "Hola Mundo con AES en modo CTR"
print(datos)
d = AES_CIPHER(key)
