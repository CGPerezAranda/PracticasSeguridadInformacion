...
#Crea par de claves para Alice y Bob
...
guardar_RSAKey_Publica("A_pub.pkcs",RSA_A)
guardar_RSAKey_Publica("B_pub.pkcs",RSA_B)
guardar_RSAKey_Privada("A_priv.pkcs",RSA_A,password)
guardar_RSAKey_Privada("B_priv.pkcs",RSA_B,password)
