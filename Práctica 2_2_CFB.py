...
class AES_CIPHER:
    ...
    def cifrar(self, cadena, IV):
        ...
        # Crea un mecanismo de cifrado AES en modo CFB
        cadena = cadena.encode("utf-8")
        cypher = AES.new(self.key, AES.MODE_CFB, IV)
    ...
    def descifrar(self, cifrado, IV):
        ...
        # Creo un mecanismo de descifrado AES en modo CFB
...
datos = "Hola Mundo con AES en modo CFB"
print(datos)
d = AES_CIPHER(key)
